...
var C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: o = false, preserveScroll: c = false, preserveState: h = false, only: m = [], headers: b2 = {}, errorBag: a = "", forceFormData: l = false, onCancelToken: g = () => {
    ...
    this.activeVisit = { ...P, onCancelToken: g, onBefore: L, onStart: d, onProgress: p, onFinish: T, onCancel: y, onSuccess: D2, onError: U2, queryStringArrayFormat: F2, cancelToken: new AbortController() }, g({ cancel: () => {
      ...
      let E2 = x, V2 = v(s.url);
      return E2.hash && !V2.hash && w(E2).href === V2.href && (V2.hash = E2.hash, s.url = V2.href), this.setPage(s, { visitId: G, replace: o, preserveScroll: c, preserveState: h });
    }).then(() => {
...
var N2 = (0, import_react3.createContext)(void 0);
N2.displayName = "InertiaHeadContext";
var A2 = N2;
var $2 = (0, import_react4.createContext)(void 0);
$2.displayName = "InertiaPageContext";
var E = $2;
function O2({ children: l, initialPage: c, initialComponent: s, resolveComponent: p, titleCallback: a, onHeadUpdate: S2 }) {
...
async function U({ id: l = "app", resolve: c, setup: s, title: p, progress: a = {}, page: S2, render: d }) {
  let P = typeof window > "u", u2 = P ? null : document.getElementById(l), g = S2 || JSON.parse(u2.dataset.page), f2 = (r) => Promise.resolve(c(r)).then((y) => y.default || y), e = [], i = await f2(g.component).then((r) => s({ el: u2, App: O2, props: { initialPage: g, initialComponent: r, resolveComponent: f2, titleCallback: p, onHeadUpdate: P ? (y) => e = y : null } }));
  if (!P && a && Z(a), P) {
    let r = await d((0, import_react.createElement)("div", { id: l, "data-page": JSON.stringify(g) }, i));
    return { head: e, body: r };
  }
}
var ae2 = function({ children: l, title: c }) {
...
var K2 = (0, import_react6.forwardRef)(({ children: l, as: c = "a", data: s = {}, href: p, method: a = "get", preserveScroll: S2 = false, preserveState: d = null, replace: P = false, only: u2 = [], headers: g = {}, queryStringArrayFormat: f2 = "brackets", onClick: e = F, onCancelToken: i = F, onBefore: r = F, onStart: y = F, onProgress: T = F, onFinish: H2 = F, onCancel: h = F, onSuccess: M2 = F, onError: x = F, ...L }, R2) => {
  let I2 = (0, import_react6.useCallback)((t) => {
    e(t), ee(t) && (t.preventDefault(), Oe.visit(p, { data: s, method: a, preserveScroll: S2, preserveState: d ?? a !== "get", replace: P, only: u2, headers: g, onCancelToken: i, onBefore: r, onStart: y, onProgress: T, onFinish: H2, onCancel: h, onSuccess: M2, onError: x }));
  }, [s, p, a, S2, d, P, u2, g, e, i, r, y, T, H2, h, M2, x]);
  c = c.toLowerCase(), a = a.toLowerCase();
  let [v2, w2] = k(a, p || "", s, f2);
  return p = v2, s = w2, c === "a" && a !== "get" && console.warn(`Creating POST/PUT/PATCH/DELETE <a> links is discouraged as it causes "Open Link in New Tab/Window" accessibility issues.

Please specify a more appropriate element using the "as" attribute. For example:

<Link href="${p}" method="${a}" as="button">...</Link>`), (0, import_react6.createElement)(c, { ...L, ...c === "a" ? { href: p } : {}, ref: R2, onClick: I2 }, l);
});
K2.displayName = "InertiaLink";
var fe = K2;
function D(l, c) {
...
function q2(l, c) {
  ...
  let v2 = (0, import_react7.useCallback)((t, n, o = {}) => {
    let k2 = { ...o, onCancelToken: (m) => {
      ...
      if (h(m), o.onProgress)
        return o.onProgress(m);
    }, onSuccess: (m) => {
      if (s.current && (T(false), h(null), e({}), r(false), x(true), R2(true), P.current = setTimeout(() => {
        s.current && R2(false);
      }, 2e3)), o.onSuccess)
        return o.onSuccess(m);
    }, onError: (m) => {
      if (s.current && (T(false), h(null), e(m), r(true)), o.onError)
        return o.onError(m);
    }, onCancel: () => {
      if (s.current && (T(false), h(null)), o.onCancel)
        return o.onCancel();
    }, onFinish: () => {
      if (s.current && (T(false), h(null)), d.current = null, o.onFinish)
        return o.onFinish();
    } };
    t === "delete" ? Oe.delete(n, { ...k2, data: I2(u2) }) : Oe[t](n, I2(u2), k2);
  }, [u2, e]);
  function w2(...t) {
    e((n) => {
      let o = Object.keys(n).reduce((k2, m) => ({ ...k2, ...t.length > 0 && !t.includes(m) ? { [m]: n[m] } : {} }), {});
      return r(Object.keys(o).length > 0), o;
    });
  }
  return { data: u2, setData(t, n) {
    g(typeof t == "string" ? { ...u2, [t]: n } : typeof t == "function" ? (o) => t(o) : t);
  }, isDirty: !(0, import_lodash.default)(u2, a), errors: f2, hasErrors: i, processing: y, progress: H2, wasSuccessful: M2, recentlySuccessful: L, transform(t) {
    I2 = t;
  }, setDefaults(t, n) {
    S2(typeof t > "u" ? () => u2 : (o) => ({ ...o, ...typeof t == "string" ? { [t]: n } : t }));
  }, reset(...t) {
    t.length === 0 ? (g(a), e({}), r(false)) : (g(Object.keys(a).filter((n) => t.includes(n)).reduce((n, o) => (n[o] = a[o], n), { ...u2 })), w2(...t));
  }, setError(t, n) {
    e((o) => {
      let k2 = { ...o, ...typeof t == "string" ? { [t]: n } : t };
      return r(Object.keys(k2).length > 0), k2;
    });
  }, clearErrors: w2, submit: v2, get(t, n) {
    v2("get", t, n);
  }, post(t, n) {
    v2("post", t, n);
  }, put(t, n) {
